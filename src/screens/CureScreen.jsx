...
import { withStage } from '../lib/tokens.js';
import { Stepper, Btn, Input } from '../components/primitives.jsx';
import { TopBar, BottomBar } from '../components/Chrome.jsx';
// Cure screen — storage method, container, light, temp, time
const { useState: useStateC } = React;

export function CureScreen({ batch, setBatch, onContinue, onBack, unit, tempUnit, theme }) {
  const t = withStage(theme, 'cure');
...
function Section({ label, children, theme }) {
  const t = withStage(theme, window.__stage);
  return (
