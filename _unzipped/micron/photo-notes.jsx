...
function PhotoNotes({ label, value = '', photos = [], onChange, onPhotosChange, placeholder, theme, accentColor }) {
...
function ComboField({ label, value, onChange, options = [], allowAdd = true, placeholder, theme }) {
  const t = (window.__stage && window.withStage) ? window.withStage(theme, window.__stage) : window.MicronTokens[theme];
...
Object.assign(window, { PhotoNotes, ComboField, DateField });
